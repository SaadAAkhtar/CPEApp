  ...
  window.extractData = function() {
    ...
    function onReady(smart)  {
      if (smart.hasOwnProperty('patient')) { 
        ...
        $.when(pt, obv, medicationOrder).done(function(patient, obv, medicationOrder) {
          //Function streamline
          ...
          for (i = 0; i < len; i++) {
            if (typeof medicationOrder[i] !== 'undefined' && typeof medicationOrder[i].medicationCodeableConcept !== 'undefined') {
